    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link waves-effect waves-light" href="#"><button type="button" class="btn btn-warning" name="button">Product</button> <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link waves-effect waves-light" href="#"><button type="button" class="btn btn-default" name="button">Customers</button> </a>
        </li>
        <li class="nav-item">
          <a class="nav-link waves-effect waves-light" href="#" style="color:black;">Use Cases</a>
        </li>
        <li>
